...
models. Queries are represented by instances of the `Query`_ class. This
...
.. _Query: https://github.com/perfectsense/dari/blob/master/db/src/main/java/com/psddev/dari/db/Query.java